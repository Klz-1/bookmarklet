  ...
  if (isAuthenticated && user) {
    return (
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={signOut}
          className="px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
        >
          Sign out
        </button>
      </div>
